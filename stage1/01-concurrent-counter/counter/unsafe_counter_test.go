...
// TestCounter_Concurrent tests the counter with multiple goroutines.
...
// TestCounter_ConcurrentIncrementDecrement tests mixed operations.
// Run with: go test -race -v
func TestCounter_ConcurrentIncrementDecrement(t *testing.T) {
	c := NewCounter()
	numGoroutines := 50
