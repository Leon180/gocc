...
func TestMutexCounter_Basic(t *testing.T) {
	c := NewMutexCounter()
...
// TestMutexCounter_Concurrent tests the counter with multiple goroutines.
...
// TestMutexCounter_ConcurrentIncrementDecrement tests mixed operations.
// Run with: go test -race -v
func TestMutexCounter_ConcurrentIncrementDecrement(t *testing.T) {
	c := NewMutexCounter()
	numGoroutines := 50
